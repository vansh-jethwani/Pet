...
export default function Header() {
  ...
  // Stable references — prevent NotificationWidget's outside-click
  // useEffect from re-registering on every render
  ...
  return (
    <>
        ...
        <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <SignedOut>
              ...
              <Link to="/signup" className="px-4 py-2 text-sm font-medium text-white bg-dogs rounded-lg hover:bg-orange-600 transition-colors shadow-lg">
                Sign Up
              </Link>
            </SignedOut>
      ...
      {/* NotificationWidget sits outside <header> so its z-50 fixed panel
